...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const response = await fetch("../abi/AccessControl.json");
    const MoodContractABI = await response.json(); 
    
    const MoodContractAddress = "0x88652d2127DFDa1D4c1E28685B9927382dA498D0";
